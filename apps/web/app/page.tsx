...
export default function Home() {
  ...
  const screens = [
    { href: "/register", title: "登録", desc: "拾得物を撮影・AIタグ付けして登録。スマホ対応。", tag: "現場" },
    { href: "/search", title: "探す", desc: "特徴のベクトル検索とフィルタで該当物品を照会。", tag: "受付" },
    { href: "/matches", title: "照合", desc: "問い合わせと遺失物の突き合わせを確認・確定。", tag: "受付" },
    { href: "/admin", title: "管理", desc: "一覧の直接編集・問い合わせ管理・設定・PDF出力。", tag: "スタッフ" },
  ];
    ...
    <AppShell>
      <div className="rb-between mb-16">
        ...
        <div className="rb-row">
          <Badge tone={health ? "success" : "error"}>
            {health ? `API接続 OK` : "API未接続"}
          </Badge>
