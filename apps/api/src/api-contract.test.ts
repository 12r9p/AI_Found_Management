...
test("developだけでScalar UIとOpenAPI JSONを公開する", async () => {
  const develop = createApp(undefined, { appEnv: "develop" });
  ...
  const production = createApp(undefined, { appEnv: "production" });
